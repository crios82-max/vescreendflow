...
@Composable
internal fun SettingsVehicleSignalsPanel(
    prefs: VePrefs,
    signalSource: String,
    onSignalSourceChange: (String) -> Unit,
    obdAddr: String,
    onObdAddrChange: (String) -> Unit,
    canBackend: String,
    ...
    prefs: VePrefs, signalSource: String, onSignalSourceChange: (String) -> Unit, obdAddr: String, onObdAddrChange: (String) -> Unit, canBackend: String, onCanBackendChange: (String) -> Unit, canIface: String, onCanIfaceChange: (String) -> Unit, fmBackend: String, onFmBackendChange: (String) -> Unit, onStatus: (String) -> Unit, context: android.content.Context, scope: CoroutineScope, live: com.veplayer.app.vehicle.VehicleSignals,
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Button(
                    onClick = {
                        ...
                        if (signalSource == "can") CanBusManager.rebind()
                        onStatus("DBC demo cargado")
                    },
                ) { Text("Demo DBC") }
                OutlinedButton(
                    onClick = {
                        scope.launch {
                            onStatus("Descargando DBC…")
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                OutlinedButton(
                    onClick = {
                        scope.launch {
                            onStatus("Descargando marca demo…")
        ...
        PanelBlock("Navegación") {
            ...
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        ...
                        onStatus(if (it) "Nav ON" else "Nav OFF")
                    },
                )
            }
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        ...
                        onStatus(if (it) "TTS ON" else "TTS OFF")
                    },
                )
            }
            OutlinedButton(
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        ...
                        onStatus(if (it) "Tiles OSM ON" else "Tiles OSM OFF")
                    },
                )
            }
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                OutlinedButton(
                    onClick = {
                        com.veplayer.app.ui.map.OsmPrefetch.refreshStats(context)
                        onStatus("Caché ${"%.1f".format(com.veplayer.app.ui.map.OsmPrefetch.state.value.cacheMb)} MB")
                    },
                ) { Text("Refresh") }
            }
            Text(
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        ...
                        onStatus(if (it) "Crowd ON" else "Crowd OFF")
                    },
                )
            }
            ...
            Row(
                ...
                Switch(
                    ...
                    onCheckedChange = {
                        towSim = it
                        prefs.towSim = it
                        onStatus(if (it) "Tow sim ON" else "Tow sim OFF")
                    },
                )
            }
            Text(
        ...
        PanelBlock("Mantenimiento odómetro") {
                ...
                Row(
                    ...
                    OutlinedButton(
                        onClick = {
                            ...
                            onStatus("Servicio ${item.label} @ ${at.toInt()} km")
                        },
                    ) { Text("Hecho") }
                }
            }
            OutlinedButton(
                onClick = {
                    ...
                    prefs.maintenanceJson =
                        com.veplayer.app.vehicle.Maintenance.toJson(items)
                    onStatus("Intervalos por defecto @ ${base.toInt()} km")
                },
        ...
        PanelBlock("Conductor") {
                    ...
                    onClick = {
                        scope.launch {
                            ...
                            r.onSuccess {
                                ...
                                onStatus("Conductor → ${it.name}")
                            }.onFailure {
                                onStatus("Login conductor: ${it.message}")
                            }
                        }
                    },
                ) { Text("Entrar") }
            ...
            OutlinedButton(
                onClick = {
                    ...
                    onStatus("Fatiga sim ${prefs.fatigueSimHours} h · umbrales ${prefs.fatigueWarnHours}/${prefs.fatigueAlertHours} h")
                },
