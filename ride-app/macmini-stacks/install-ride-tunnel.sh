...
log "  CNAME ride-api -> ${TUNNEL_ID}.cfargotunnel.com (Proxied)"
log "  CNAME ride     -> ${TUNNEL_ID}.cfargotunnel.com (Proxied)"
log ""
log "En ride-app/.env:"
log "  API_PUBLIC_URL=https://ride-api.vescreenflow.com"
log "  VITE_API_URL=https://ride-api.vescreenflow.com"
log "  EXPO_PUBLIC_API_URL=https://ride-api.vescreenflow.com"
log "  PASSENGER_WEB_URL=https://ride.vescreenflow.com"
log "  CORS_ORIGINS=https://ride-api.vescreenflow.com,https://ride.vescreenflow.com,..."
log ""
log "Tras editar .env: npm run build && pm2 restart ride-api ride-passenger --update-env"
log ""
log "Verificar:"
log "  ./scripts/check-prod.sh"
log "  curl -sf https://ride-api.vescreenflow.com/health"
log "  curl -sf -o /dev/null https://ride.vescreenflow.com"
