...
| PID | Monitor | Alertas | HUD |
|-----|---------|---------|-----|
| 019D | Engine fuel rate g/s | `engine_fuel_rate_gps_warn` / `engine_fuel_rate_gps_alert` | `FuelGPS · X.X` |
| 019E | Exhaust flow | `exhaust_flow_warn` / `exhaust_flow_alert` | `ExhFlow · XXX` |
| 019F | Fuel sys use 1 | `fuel_sys_use1_warn` / `fuel_sys_use1_alert` | `FSu1 · XX%` |
| 019F | Fuel sys use 2 | `fuel_sys_use2_warn` / `fuel_sys_use2_alert` | `FSu2 · XX%` |
...
Continúa bloque HEV **01D8 / 01D0**.

| PID | Señal | Alertas | HUD |
|-----|-------|---------|-----|
| 01D8 A bit0 | Battery capacity calc ready | `bcap_ready_warn` | `Bcap · Ready/NotReady` |
| 01D0 A/B | Remaining ESS reserve kWh | `ess_rsrv_warn` / `ess_rsrv_alert` | `EssRsrv · XXkWh` |
...
Continúa bloque HEV **01D1 / 01D4**.

| PID | Señal | Alertas | HUD |
|-----|-------|---------|-----|
| 01D1 A/B | ESS charge limit kW | `ess_chg_lim_warn` / `ess_chg_lim_alert` | `EssLim · XXkW` |
| 01D1 C/D | ESS charge actual kW | `ess_chg_act_warn` / `ess_chg_act_alert` | `EssAct · XXkW` |
...
Fuel cell + ciclos de propulsión **01D5 / 01D6**.

| PID | Señal | Alertas | HUD |
|-----|-------|---------|-----|
| 01D5 A/B | FC voltage V (/10) | `fc_volt_warn` / `fc_volt_alert` | `FcV · XXV` |
| 01D5 C/D | FC fuel rate g/s (/100) | `fc_fuel_rate_warn` / `fc_fuel_rate_alert` | `FcFuel · XXg/s` |
| 01D6 A/B | Propulsion system trips | `ps_trips_warn` / `ps_trips_alert` | `PsTrips · N` |
