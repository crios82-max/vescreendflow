...
log "  PASSENGER_WEB_URL=https://movify.vescreenflow.com"
log "  CORS_ORIGINS=https://movify-api.vescreenflow.com,https://movify.vescreenflow.com,..."
log ""
log "Tras editar .env: npm run build && pm2 restart ride-api ride-passenger --update-env"
log ""
log "Verificar:"
log "  ./scripts/check-prod.sh"
log "  curl -sf https://movify-api.vescreenflow.com/health"
log "  curl -sf -o /dev/null https://movify.vescreenflow.com"
