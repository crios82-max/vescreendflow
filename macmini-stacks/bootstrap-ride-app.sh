...
docker compose up -d
chmod +x scripts/migrate.sh scripts/start-stack.sh scripts/stop-stack.sh scripts/check-prod.sh scripts/setup-prod-env.sh scripts/go-live.sh scripts/setup-eas-secrets.sh scripts/eas-testflight.sh
./scripts/migrate.sh
